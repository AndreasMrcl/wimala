...
<div id="addModal"
    ...
    <div class="bg-white rounded-2xl p-8 w-full max-w-lg shadow-2xl relative">
        ...
        <h2 class="text-2xl font-bold mb-6 text-gray-800 flex items-center gap-2">
            <i class="fas fa-house-chimney text-sky-600"></i> Tambah Tipe Rumah
        </h2>

        <form action="{{ route('tipe.store') }}" method="POST" class="space-y-5">
            @csrf
            <div>
                ...
                <input type="text" name="nama"
                    ...
                    required placeholder="mis. Tipe 36/72">
            </div>
            ...
            <div class="grid grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input type="number" name="luas_bangunan" min="0"
                        class="w-full rounded-lg border-gray-300 shadow-sm p-2.5 border focus:ring-2 focus:ring-sky-500"
                        required placeholder="0">
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-5">
                <div>
                    ...
                    <input type="number" name="kamar_tidur" min="0" value="0"
                        class="w-full rounded-lg border-gray-300 shadow-sm p-2.5 border focus:ring-2 focus:ring-sky-500"
                        required>
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Kamar Mandi</label>
                    <input type="number" name="kamar_mandi" min="0" value="0"
                        class="w-full rounded-lg border-gray-300 shadow-sm p-2.5 border focus:ring-2 focus:ring-sky-500"
                        required>
                </div>
            </div>
            ...
            <div>
                ...
                <input type="text" name="harga_dasar" value="0"
